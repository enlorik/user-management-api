...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        logger.info("Configuring security filter chain with session-based authentication");
        
        http
            .csrf(csrf -> csrf
                // Disable CSRF for REST API endpoints (consumed by programmatic clients)
                .ignoringRequestMatchers("/users/**", "/api/**", "/actuator/health", "/actuator/health/**")
            )
